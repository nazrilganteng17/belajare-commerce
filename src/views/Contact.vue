      ...
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="mailto:nazrilihamaldinonazril@gmail.com?subject=haiiiii%20saputtt">nazrilihamaldinonazril@gmail.com</a>
            
            </div>
          </li>
          <a href="https://www.instagram.com/nazrlllham">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="https://www.instagram.com/nazrlllham">nazrlllham</a>
            
            </div>
          </li>
          </a>
         <a href="https://wa.link/pix9qo">
            <li class="my-6 flex items-center text-left">
            ...
            <div>
              <p class="font-serif text-base md:text-lg">08376977235</p>
